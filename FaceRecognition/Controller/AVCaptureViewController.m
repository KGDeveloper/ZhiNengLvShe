...
//        //根据设备输出获得连接
//        AVCaptureConnection *connection = [self.metadataOutput connectionWithMediaType:AVMediaTypeVideo];
//        
//        
//        // 前置摄像头翻转
//        AVCaptureDevicePosition currentPosition = _device.position;
...
//        }
        ...
        for (AVCaptureDevice *tmp in deviceArr) {
...
//        if (_device.position == AVCaptureDevicePositionUnspecified || _device.position == AVCaptureDevicePositionFront) {
//            
//        } else {
//            
//        }
...
- (void)viewDidLoad {
    ...
    IDCardScaningView.layer.transform=CATransform3DMakeRotation(M_PI, 0, 1, 0);
